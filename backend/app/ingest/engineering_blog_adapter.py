...
class EngineeringBlogAdapter(IngestionAdapter):
    source_name = "engineering_blog"
                ...
                results.append(
                    {
                        ...
                        "organizations": [publisher] if publisher else [],
                        "topic": query,
                        "timestamp": timestamp,
                        "metadata": {"feed_url": feed_url, "publisher": publisher},
                        "signals": [
                            {
                                "source_type": self.source_name,
                                "mentions": 1,
                                "evidence": [
                                    "Matched query in company engineering blog RSS feed",
                                    f"Publisher: {publisher or 'engineering blog'}",
                                ],
